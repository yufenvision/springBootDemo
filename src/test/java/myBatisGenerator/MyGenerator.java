...
public class MyGenerator {
	...
	final static String  dirPath = new File("").getAbsolutePath()+"\\src\\main";
//	final static String testPath = System.getProperty("user.dir");
...
/*        focList.add(new FileOutConfig("/template/list.jsp.vm") {
      ...
      focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return dirPath+"\\resources\\mapper\\" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
        cfg.setFileOutConfigList(focList);
...
/*        TemplateConfig tc = new TemplateConfig();
        ...
        TemplateConfig tc = new TemplateConfig();
        tc.setEntity("templates/myEntity.java.vm");
